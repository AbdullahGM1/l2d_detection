...
def generate_launch_description():
    ...
    yolov8_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            'model': '/home/user/shared_volume/ros2_ws/src/smart_track/config/depth_detection.pt',
            'threshold': '0.5',
    ...
    #     ]
    # )
    depth_map_detection = Node(
        package='depth_map_detection',  
        executable='depth_map_detection',  
    ...
    ld.add_action(depth_map_detection)
